...
const features = [
  {
    ...
    description: "Connect your GitHub, revenue, and socials. The agent analyzes everything in real time and generates a public report card. No VC associate required.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Crowd Pricing",
    description: "A prediction market opens on your valuation. Bettors work from real AI-generated data, not vibes. The market converges on a number that actually means something.",
    visual: "ai",
  },
  {
    number: "03",
    title: "On-Chain Equity",
    description: "Token holders receive equity as an MPT on XRPL with transferability and fee flags set by the founder. Ownership, not a receipt.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Legal Anchor",
    description: "A legally binding SAFE deploys through MetaLex on Base. The on-chain token connects to a real legal agreement. No promises, no gray area.",
    visual: "security",
  },
];
  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        const x2 = Math.round((100 + Math.cos(angle) * radius) * 1e6) / 1e6;
        const y2 = Math.round((80 + Math.sin(angle) * radius) * 1e6) / 1e6;
        return (
          <g key={i}>
            {/* Connection line */}
            <line
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Full transparency.
            <br />
            <span className="text-muted-foreground">Real ownership.</span>
          </h2>
        </div>
