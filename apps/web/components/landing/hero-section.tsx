      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 pt-32 lg:pt-40 pb-0 flex-1 flex flex-col justify-center">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-muted-foreground">
            ...
            The platform for transparent fundraising
          </span>
        </div>
        ...
        <div className="mb-12">
          <h1 
            className={`text-[clamp(3rem,12vw,10rem)] font-display leading-[1.05] tracking-tight transition-all duration-1000 ${
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            Stop raising on vibes and network. Lapis forces transparency, lets the crowd price your startup, and converts token holders into real equity owners.
          </p>
