...
const testimonials = [
  {
    quote: "The crowd priced us at $8M. Three VCs had passed at $5M.",
    author: "Anonymous Founder",
    role: "Founder",
    company: "Seed-stage SaaS",
    metric: "$8M crowd valuation",
  },
  {
    quote: "Token holders finally own what they funded. This should have existed years ago.",
    author: "Early Backer",
    role: "Early backer",
    company: "DeFi protocol",
    metric: "100% holder conversion to equity",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="mt-24 pt-12 border-t border-foreground/10">
          <p className="font-mono text-xs tracking-widest text-muted-foreground uppercase mb-8 text-center">
            Trusted by founders who raise on merit
          </p>
        </div>
      </div>
